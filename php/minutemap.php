...
$sql = "With i as(SELECT DISTINCT ON (end_vid) *, agg_cost/60 as cost_m, samplepoint_vertice_comparison.geom as pointgeom
FROM current.samplepoint_vertice_comparison,
pgr_dijkstra('SELECT pk as id, source, target, costs as cost, reverse_costs as reverse_cost FROM current.merged_ways'," . $vertice . ", (select array_agg(id::integer) as array
